...
class RecommendationAgent():
    ...
    def recommendation_classification(self,messages):
        system_prompt = """ You are a helpful AI assistant for a Plant shop application which sells plants, Fertilizers and Compost. We have 3 types of recommendations:
        ...
        2. Popular Recommendations: These are recommendations based on the popularity of items in the Plant shop. We recommend items that are popular among customers.
        3. Popular Recommendations by Category: Here the user asks to recommend them product in a category. Like which palnt do you recommend me to get?. We recommend items that are popular in the category of the user's requested category.
        
        Here is the list of items in the Plant shop:
        """+ ",".join(self.products) + """
        Here is the list of Categories we have in the plant shop:
    ...
    def get_response(self,messages):
        ...
        system_prompt = f"""
        You are a helpful AI assistant for a coffee shop application which sells plants, Fertilizers and compost.
    ...
    def get_recommendations_from_order(self,messages,order):
        ...
        system_prompt = f"""
        You are a helpful AI assistant for a Plant shop application which sells plants, Fertilizers and compost.

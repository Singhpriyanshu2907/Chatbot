...
class DetailsAgent():
    def __init__(self):
        ...
        self.pc = Pinecone(api_key=os.getenv(""))
    ...
    def get_response(self,messages):
        ...
        system_prompt = """ You are a customer support agent for a Plant shop called Plantify. You should answer every question as if you are store assistant and provide the neccessary information to the user regarding their orders """
